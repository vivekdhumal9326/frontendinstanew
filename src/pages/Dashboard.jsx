...
export default function Dashboard() {
  ...
  const packages = [
    ...
    { id: 1, name: '5000 Instagram Followers', price: '₹ 700', count: 5000, bogo: true },
    ...
    { id: 11, name: '20000 Instagram Views', price: '₹ 3,550', count: 20000 },

    { id: 12, name: '50000 Instagram Views', price: '₹ 5,900', count: 50000 },

    { id: 13, name: '100000 Instagram Views', price: '₹ 12,000', count: 100000 },
    ...
    { id: 20, name: '100 Youtube Likes', price: '₹ 1000', count: 100 }
        ...
        <div>
          ...
          {selectedPackage?.bogo && (
            <div style={{
              ...
              🎉 BUY 1 GET 1 FREE OFFER APPLIED!
            </div>
          )}
